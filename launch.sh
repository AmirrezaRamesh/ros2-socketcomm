...
# usage:
#     ./launch.sh <starting_number> <my_ip> <target_ip> <target-user>
# example:
#     ./launch.sh 8000 192.168.1.10 192.168.1.20 ros_user
...
#ssh quietly to remote server, start tmux session, source env, run node
ssh -q "$REMOTE_USER@$TARGET_IP" << EOF
